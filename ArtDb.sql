...
/****** Object:  Database [Art]    Script Date: 4/9/2020 22:15:54 ******/
CREATE DATABASE [Art]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Art', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\Art.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Art_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\Art_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [Art] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [Art] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [Art] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [Art] SET RECOVERY SIMPLE 
GO
